...
export default function Register(props) {
    ...
    return (
        <Modal isOpen={modalContext.openModal === "signUp"} onRequestClose={closeModal} contentLabel={"Sign Up"} className={styles.modal} overlayClassName={styles.overlay}>
