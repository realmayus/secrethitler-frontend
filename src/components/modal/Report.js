...
export default function Report(props) {
    ...
    return(
        <Modal
            isOpen={modalContext.openModal === "report"}
            onRequestClose={closeModal}
            contentLabel={"Report"}
            className={styles.modal}
            overlayClassName={styles.overlay}
        >
            <h2 className={styles.headline}>Report {whatToReport === "player" ? "a Player" : ''} {whatToReport === "bug" ? "a bug" : ''}</h2>
            { whatToReport == null &&
                <div>
            ...
            { whatToReport === "bug" &&
                <div>
                    ...
                    <br/>
                    <p>If you're unsure or don't have a GitHub account and don't want to create one, you can also report bugs on our <a href={discordLink}>Discord server</a>.</p>
                </div>
            }
